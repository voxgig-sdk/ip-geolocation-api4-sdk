...
describe("AdvancedDirect", function()
  it("should direct-load-advanced", function()
    local setup = advanced_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-advanced", setup.live and "live" or "unit")
...
function advanced_direct_setup(mockres)
