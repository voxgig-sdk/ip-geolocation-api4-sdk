...
describe("StatusDirect", function()
  it("should direct-load-status", function()
    local setup = status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-status", setup.live and "live" or "unit")
...
function status_direct_setup(mockres)
