...
describe("TorDirect", function()
  it("should direct-load-tor", function()
    local setup = tor_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-tor", setup.live and "live" or "unit")
...
function tor_direct_setup(mockres)
