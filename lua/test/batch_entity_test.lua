...
describe("BatchEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set IP_GEOLOCATION_API4_TEST_BATCH_ENTID JSON to run live")
      return
    end
...
function batch_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("IP_GEOLOCATION_API4_TEST_BATCH_ENTID")
