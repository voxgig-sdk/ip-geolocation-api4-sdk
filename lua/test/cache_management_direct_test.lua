...
describe("CacheManagementDirect", function()
  it("should direct-load-cache_management", function()
    local setup = cache_management_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cache_management", setup.live and "live" or "unit")
...
function cache_management_direct_setup(mockres)
