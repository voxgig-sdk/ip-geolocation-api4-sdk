...
describe("IpReputationDirect", function()
  it("should direct-load-ip_reputation", function()
    local setup = ip_reputation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ip_reputation", setup.live and "live" or "unit")
...
function ip_reputation_direct_setup(mockres)
