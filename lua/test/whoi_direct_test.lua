...
describe("WhoiDirect", function()
  it("should direct-load-whoi", function()
    local setup = whoi_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-whoi", setup.live and "live" or "unit")
