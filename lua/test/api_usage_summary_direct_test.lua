...
describe("ApiUsageSummaryDirect", function()
  it("should direct-load-api_usage_summary", function()
    local setup = api_usage_summary_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_usage_summary", setup.live and "live" or "unit")
...
function api_usage_summary_direct_setup(mockres)
