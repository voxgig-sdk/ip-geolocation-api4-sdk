...
describe("DomainAnalysiDirect", function()
  it("should direct-load-domain_analysi", function()
    local setup = domain_analysi_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-domain_analysi", setup.live and "live" or "unit")
...
function domain_analysi_direct_setup(mockres)
