...
describe("MxnDirect", function()
  it("should direct-load-mxn", function()
    local setup = mxn_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-mxn", setup.live and "live" or "unit")
...
function mxn_direct_setup(mockres)
