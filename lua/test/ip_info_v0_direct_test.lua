...
describe("IpInfoV0Direct", function()
  it("should direct-load-ip_info_v0", function()
    local setup = ip_info_v0_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ip_info_v0", setup.live and "live" or "unit")
...
function ip_info_v0_direct_setup(mockres)
