...
describe("ReverseDirect", function()
  it("should direct-load-reverse", function()
    local setup = reverse_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-reverse", setup.live and "live" or "unit")
...
function reverse_direct_setup(mockres)
