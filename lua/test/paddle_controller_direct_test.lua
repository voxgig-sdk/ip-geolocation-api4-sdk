...
describe("PaddleControllerDirect", function()
  it("should direct-load-paddle_controller", function()
    local setup = paddle_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-paddle_controller", setup.live and "live" or "unit")
...
function paddle_controller_direct_setup(mockres)
