...
describe("UsageStatisticDirect", function()
  it("should direct-load-usage_statistic", function()
    local setup = usage_statistic_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-usage_statistic", setup.live and "live" or "unit")
...
function usage_statistic_direct_setup(mockres)
