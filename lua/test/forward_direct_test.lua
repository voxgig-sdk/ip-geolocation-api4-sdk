...
describe("ForwardDirect", function()
  it("should direct-load-forward", function()
    local setup = forward_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-forward", setup.live and "live" or "unit")
...
function forward_direct_setup(mockres)
