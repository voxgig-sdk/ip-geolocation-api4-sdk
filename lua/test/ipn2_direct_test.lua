...
describe("Ipn2Direct", function()
  it("should direct-load-ipn2", function()
    local setup = ipn2_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ipn2", setup.live and "live" or "unit")
...
function ipn2_direct_setup(mockres)
