...
describe("DomainReputationV1DtoDirect", function()
  it("should direct-load-domain_reputation_v1_dto", function()
    local setup = domain_reputation_v1_dto_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-domain_reputation_v1_dto", setup.live and "live" or "unit")
...
function domain_reputation_v1_dto_direct_setup(mockres)
