...
function runner.env_override(m)
  local live = runner.getenv("IPGEOLOCATIONAPI4_TEST_LIVE")
  local override = runner.getenv("IPGEOLOCATIONAPI4_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IPGEOLOCATIONAPI4_TEST_EXPLAIN")
