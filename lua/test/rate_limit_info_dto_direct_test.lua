...
describe("RateLimitInfoDtoDirect", function()
  it("should direct-load-rate_limit_info_dto", function()
    local setup = rate_limit_info_dto_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-rate_limit_info_dto", setup.live and "live" or "unit")
...
function rate_limit_info_dto_direct_setup(mockres)
