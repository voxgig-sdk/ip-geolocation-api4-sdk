...
describe("MxnEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set IPGEOLOCATIONAPI__TEST_MXN_ENTID JSON to run live")
      return
    end
...
function mxn_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("IPGEOLOCATIONAPI__TEST_MXN_ENTID")
