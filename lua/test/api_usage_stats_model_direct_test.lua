...
describe("ApiUsageStatsModelDirect", function()
  it("should direct-load-api_usage_stats_model", function()
    local setup = api_usage_stats_model_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_usage_stats_model", setup.live and "live" or "unit")
