...
describe("RiskScoreDirect", function()
  it("should direct-load-risk_score", function()
    local setup = risk_score_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-risk_score", setup.live and "live" or "unit")
...
function risk_score_direct_setup(mockres)
