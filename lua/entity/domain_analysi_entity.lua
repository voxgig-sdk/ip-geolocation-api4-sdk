...
local DomainAnalysiEntity = {}
DomainAnalysiEntity.__index = DomainAnalysiEntity


function DomainAnalysiEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DomainAnalysiEntity)
  self._name = "domain_analysi"
  self._client = client
...
function DomainAnalysiEntity:get_name()
  return self._name
end


function DomainAnalysiEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DomainAnalysiEntity.new(self._client, opts)
end
...
function DomainAnalysiEntity:mark_deleted()
  self._deleted = true
end


function DomainAnalysiEntity:deleted()
  return true == self._deleted
end


function DomainAnalysiEntity:data_set(args)
  if args ~= nil then
...
function DomainAnalysiEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DomainAnalysiEntity:match_set(args)
  if args ~= nil then
...
function DomainAnalysiEntity:match_get()
...
function DomainAnalysiEntity:stream(action, args, callopts)
...
---@param reqmatch DomainAnalysiLoadMatch
---@param ctrl? table
---@return DomainAnalysi
---@return string? err
function DomainAnalysiEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DomainAnalysiCreateData
---@param ctrl? table
---@return DomainAnalysi
---@return string? err
function DomainAnalysiEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function DomainAnalysiEntity:_run_op(ctx, post_done)
  local utility = self._utility
