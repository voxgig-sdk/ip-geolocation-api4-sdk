...
local RateLimitInfoDtoEntity = {}
RateLimitInfoDtoEntity.__index = RateLimitInfoDtoEntity


function RateLimitInfoDtoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RateLimitInfoDtoEntity)
  self._name = "rate_limit_info_dto"
  self._client = client
...
function RateLimitInfoDtoEntity:get_name()
  return self._name
end


function RateLimitInfoDtoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RateLimitInfoDtoEntity.new(self._client, opts)
end
...
function RateLimitInfoDtoEntity:mark_deleted()
  self._deleted = true
end


function RateLimitInfoDtoEntity:deleted()
  return true == self._deleted
end


function RateLimitInfoDtoEntity:data_set(args)
  if args ~= nil then
...
function RateLimitInfoDtoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RateLimitInfoDtoEntity:match_set(args)
  if args ~= nil then
...
function RateLimitInfoDtoEntity:match_get()
...
function RateLimitInfoDtoEntity:stream(action, args, callopts)
...
---@param reqmatch RateLimitInfoDtoLoadMatch
---@param ctrl? table
---@return RateLimitInfoDto
---@return string? err
function RateLimitInfoDtoEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RateLimitInfoDtoEntity:_run_op(ctx, post_done)
  local utility = self._utility
