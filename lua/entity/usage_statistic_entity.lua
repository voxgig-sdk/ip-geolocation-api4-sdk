...
local UsageStatisticEntity = {}
UsageStatisticEntity.__index = UsageStatisticEntity


function UsageStatisticEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UsageStatisticEntity)
  self._name = "usage_statistic"
  self._client = client
...
function UsageStatisticEntity:get_name()
  return self._name
end


function UsageStatisticEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UsageStatisticEntity.new(self._client, opts)
end
...
function UsageStatisticEntity:mark_deleted()
  self._deleted = true
end


function UsageStatisticEntity:deleted()
  return true == self._deleted
end


function UsageStatisticEntity:data_set(args)
  if args ~= nil then
...
function UsageStatisticEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UsageStatisticEntity:match_set(args)
  if args ~= nil then
...
function UsageStatisticEntity:match_get()
...
function UsageStatisticEntity:stream(action, args, callopts)
...
---@param reqmatch UsageStatisticLoadMatch
---@param ctrl? table
---@return UsageStatistic
---@return string? err
function UsageStatisticEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function UsageStatisticEntity:_run_op(ctx, post_done)
  local utility = self._utility
