...
local AdvancedEntity = {}
AdvancedEntity.__index = AdvancedEntity


function AdvancedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdvancedEntity)
  self._name = "advanced"
  self._client = client
...
function AdvancedEntity:get_name()
  return self._name
end


function AdvancedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdvancedEntity.new(self._client, opts)
end
...
function AdvancedEntity:mark_deleted()
  self._deleted = true
end


function AdvancedEntity:deleted()
  return true == self._deleted
end


function AdvancedEntity:data_set(args)
  if args ~= nil then
...
function AdvancedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdvancedEntity:match_set(args)
  if args ~= nil then
...
function AdvancedEntity:match_get()
...
function AdvancedEntity:stream(action, args, callopts)
...
---@param reqmatch AdvancedLoadMatch
---@param ctrl? table
---@return Advanced
---@return string? err
function AdvancedEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AdvancedEntity:_run_op(ctx, post_done)
  local utility = self._utility
