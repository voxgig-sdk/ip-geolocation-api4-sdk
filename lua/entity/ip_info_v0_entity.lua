...
local IpInfoV0Entity = {}
IpInfoV0Entity.__index = IpInfoV0Entity


function IpInfoV0Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IpInfoV0Entity)
  self._name = "ip_info_v0"
  self._client = client
...
function IpInfoV0Entity:get_name()
  return self._name
end


function IpInfoV0Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IpInfoV0Entity.new(self._client, opts)
end
...
function IpInfoV0Entity:mark_deleted()
  self._deleted = true
end


function IpInfoV0Entity:deleted()
  return true == self._deleted
end


function IpInfoV0Entity:data_set(args)
  if args ~= nil then
...
function IpInfoV0Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IpInfoV0Entity:match_set(args)
  if args ~= nil then
...
function IpInfoV0Entity:match_get()
...
function IpInfoV0Entity:stream(action, args, callopts)
...
---@param reqmatch IpInfoV0LoadMatch
---@param ctrl? table
---@return IpInfoV0
---@return string? err
function IpInfoV0Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function IpInfoV0Entity:_run_op(ctx, post_done)
  local utility = self._utility
