...
local DomainReputationV1DtoEntity = {}
DomainReputationV1DtoEntity.__index = DomainReputationV1DtoEntity


function DomainReputationV1DtoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DomainReputationV1DtoEntity)
  self._name = "domain_reputation_v1_dto"
  self._client = client
...
function DomainReputationV1DtoEntity:get_name()
  return self._name
end


function DomainReputationV1DtoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DomainReputationV1DtoEntity.new(self._client, opts)
end
...
function DomainReputationV1DtoEntity:mark_deleted()
  self._deleted = true
end


function DomainReputationV1DtoEntity:deleted()
  return true == self._deleted
end


function DomainReputationV1DtoEntity:data_set(args)
  if args ~= nil then
...
function DomainReputationV1DtoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DomainReputationV1DtoEntity:match_set(args)
  if args ~= nil then
...
function DomainReputationV1DtoEntity:match_get()
...
function DomainReputationV1DtoEntity:stream(action, args, callopts)
...
---@param reqmatch DomainReputationV1DtoLoadMatch
---@param ctrl? table
---@return DomainReputationV1Dto
---@return string? err
function DomainReputationV1DtoEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function DomainReputationV1DtoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DomainReputationV1DtoEntity
