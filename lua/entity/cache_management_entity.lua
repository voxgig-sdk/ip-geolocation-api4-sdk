...
local CacheManagementEntity = {}
CacheManagementEntity.__index = CacheManagementEntity


function CacheManagementEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CacheManagementEntity)
  self._name = "cache_management"
  self._client = client
...
function CacheManagementEntity:get_name()
  return self._name
end


function CacheManagementEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CacheManagementEntity.new(self._client, opts)
end
...
function CacheManagementEntity:mark_deleted()
  self._deleted = true
end


function CacheManagementEntity:deleted()
  return true == self._deleted
end


function CacheManagementEntity:data_set(args)
  if args ~= nil then
...
function CacheManagementEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CacheManagementEntity:match_set(args)
  if args ~= nil then
...
function CacheManagementEntity:match_get()
...
function CacheManagementEntity:stream(action, args, callopts)
...
---@param reqmatch CacheManagementLoadMatch
---@param ctrl? table
---@return CacheManagement
---@return string? err
function CacheManagementEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CacheManagementRemoveMatch
---@param ctrl? table
---@return CacheManagement
---@return string? err
function CacheManagementEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function CacheManagementEntity:_run_op(ctx, post_done)
  local utility = self._utility
