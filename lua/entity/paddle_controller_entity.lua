...
local PaddleControllerEntity = {}
PaddleControllerEntity.__index = PaddleControllerEntity


function PaddleControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PaddleControllerEntity)
  self._name = "paddle_controller"
  self._client = client
...
function PaddleControllerEntity:get_name()
  return self._name
end


function PaddleControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PaddleControllerEntity.new(self._client, opts)
end
...
function PaddleControllerEntity:mark_deleted()
  self._deleted = true
end


function PaddleControllerEntity:deleted()
  return true == self._deleted
end


function PaddleControllerEntity:data_set(args)
  if args ~= nil then
...
function PaddleControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PaddleControllerEntity:match_set(args)
  if args ~= nil then
...
function PaddleControllerEntity:match_get()
...
function PaddleControllerEntity:stream(action, args, callopts)
...
---@param reqmatch PaddleControllerLoadMatch
---@param ctrl? table
---@return PaddleController
---@return string? err
function PaddleControllerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata PaddleControllerCreateData
---@param ctrl? table
---@return PaddleController
---@return string? err
function PaddleControllerEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function PaddleControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
