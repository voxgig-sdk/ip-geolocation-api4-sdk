...
class PaddleControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaddleControllerEntity(self._client, opts)
    ...
    def data_get(self) -> PaddleController:
    ...
    def match_get(self) -> PaddleController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PaddleController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PaddleController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: PaddleControllerCreateData, ctrl=None) -> PaddleController:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
