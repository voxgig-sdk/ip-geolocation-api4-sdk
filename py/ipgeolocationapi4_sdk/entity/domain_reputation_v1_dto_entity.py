...
class DomainReputationV1DtoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DomainReputationV1DtoEntity(self._client, opts)
    ...
    def data_get(self) -> DomainReputationV1Dto:
    ...
    def match_get(self) -> DomainReputationV1Dto:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DomainReputationV1Dto:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DomainReputationV1Dto().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
