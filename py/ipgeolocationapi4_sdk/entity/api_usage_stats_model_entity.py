...
class ApiUsageStatsModelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiUsageStatsModelEntity(self._client, opts)
    ...
    def data_get(self) -> ApiUsageStatsModel:
    ...
    def match_get(self) -> ApiUsageStatsModel:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiUsageStatsModel:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiUsageStatsModel().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
