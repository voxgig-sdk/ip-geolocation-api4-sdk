...
class UsageStatisticEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UsageStatisticEntity(self._client, opts)
    ...
    def data_get(self) -> UsageStatistic:
    ...
    def match_get(self) -> UsageStatistic:
    ...
    def load(self, reqmatch=None, ctrl=None) -> UsageStatistic:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.UsageStatistic().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
