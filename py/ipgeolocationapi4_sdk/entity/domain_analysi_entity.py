...
class DomainAnalysiEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DomainAnalysiEntity(self._client, opts)
    ...
    def data_get(self) -> DomainAnalysi:
    ...
    def match_get(self) -> DomainAnalysi:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DomainAnalysi:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DomainAnalysi().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: DomainAnalysiCreateData, ctrl=None) -> DomainAnalysi:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
