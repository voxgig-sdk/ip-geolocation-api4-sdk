...
class BatchEmailValidationResponseDtoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BatchEmailValidationResponseDtoEntity(self._client, opts)
    ...
    def data_get(self) -> BatchEmailValidationResponseDto:
    ...
    def match_get(self) -> BatchEmailValidationResponseDto:
    ...
    def create(self, reqdata: BatchEmailValidationResponseDtoCreateData, ctrl=None) -> BatchEmailValidationResponseDto:
        utility = self._utility
