...
class ApiUsageSummaryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApiUsageSummaryEntity(self._client, opts)
    ...
    def data_get(self) -> ApiUsageSummary:
    ...
    def match_get(self) -> ApiUsageSummary:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApiUsageSummary:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApiUsageSummary().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
