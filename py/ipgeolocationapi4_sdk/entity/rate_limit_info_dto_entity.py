...
class RateLimitInfoDtoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RateLimitInfoDtoEntity(self._client, opts)
    ...
    def data_get(self) -> RateLimitInfoDto:
    ...
    def match_get(self) -> RateLimitInfoDto:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RateLimitInfoDto:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RateLimitInfoDto().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
