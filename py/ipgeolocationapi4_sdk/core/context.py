...
from ipgeolocationapi4_sdk.core.control import IpGeolocationApi4Control
...
from ipgeolocationapi4_sdk.core.helpers import get_ctx_prop, to_map
...
class IpGeolocationApi4Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = IpGeolocationApi4Control()
        ...
        if isinstance(sp, IpGeolocationApi4Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IpGeolocationApi4Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IpGeolocationApi4Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return IpGeolocationApi4Operation({})
    ...
    def make_error(self, code, msg):
        return IpGeolocationApi4Error(code, msg, self)
