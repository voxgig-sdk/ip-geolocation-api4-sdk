...
class TestAsnDirect:
    ...
    def test_should_direct_load_asn(self):
        setup = _asn_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-asn", "live" if setup["live"] else "unit")
        if _skip:
