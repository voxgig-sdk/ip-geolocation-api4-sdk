# IpGeolocationApi4 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpGeolocationApi4SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpGeolocationApi4SDK(...) and IpGeolocationApi4SDK.test(...) become
#      IpGeolocationApi4SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipgeolocationapi4_sdk"
_SDK_CLASS = "IpGeolocationApi4SDK"
...
_ENTITIES = {
    "Advanced": "advanced",
    "ApiUsageStatsModel": "api_usage_stats_model",
    "ApiUsageSummary": "api_usage_summary",
    "Asn": "asn",
    "Batch": "batch",
    "BatchEmailValidationResponseDto": "batch_email_validation_response_dto",
    "CacheManagement": "cache_management",
    "DomainAnalysi": "domain_analysi",
    "DomainReputationV1Dto": "domain_reputation_v1_dto",
    "Email": "email",
    "Forward": "forward",
    "IpInfoV0": "ip_info_v0",
    ...
    "Status": "status",
    "Tor": "tor",
    "UsageStatistic": "usage_statistic",
    "Whoi": "whoi",
}
