...
// IpGeolocationApi4 SDK Mxn entity
...
class MxnEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MxnEntity($this->_client, $opts);
    }

    /**
     * @param Mxn|array $args Mxn data (assoc-array) to store.
     */
    ...
    /**
     * @return Mxn|array The current Mxn data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Mxn fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Mxn fields).
     */
     ...
     * Load a single Mxn.
     *
     * @param MxnLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MxnLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Mxn|array The loaded Mxn as an assoc-array at the
