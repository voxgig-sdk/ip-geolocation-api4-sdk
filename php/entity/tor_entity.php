...
// IpGeolocationApi4 SDK Tor entity
...
class TorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TorEntity($this->_client, $opts);
    }

    /**
     * @param Tor|array $args Tor data (assoc-array) to store.
     */
    ...
    /**
     * @return Tor|array The current Tor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Tor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Tor fields).
     */
     ...
     * Load a single Tor.
     *
     * @param TorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Tor|array The loaded Tor as an assoc-array at the
