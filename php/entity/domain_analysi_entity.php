...
// IpGeolocationApi4 SDK DomainAnalysi entity
...
class DomainAnalysiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DomainAnalysiEntity($this->_client, $opts);
    }

    /**
     * @param DomainAnalysi|array $args DomainAnalysi data (assoc-array) to store.
     */
    ...
    /**
     * @return DomainAnalysi|array The current DomainAnalysi data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DomainAnalysi fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DomainAnalysi fields).
     */
    ...
    /**
     * Load a single DomainAnalysi.
     *
     * @param DomainAnalysiLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DomainAnalysiLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DomainAnalysi|array The loaded DomainAnalysi as an assoc-array at the
    ...
    /**
     * Create a new DomainAnalysi.
     *
     * @param DomainAnalysiCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DomainAnalysiCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DomainAnalysi|array The created DomainAnalysi as an assoc-array at the
     *   SDK boundary; throws IpGeolocationApi4Error on failure (item-5 convention).
     */
