...
// IpGeolocationApi4 SDK PaddleController entity
...
class PaddleControllerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PaddleControllerEntity($this->_client, $opts);
    }

    /**
     * @param PaddleController|array $args PaddleController data (assoc-array) to store.
     */
    ...
    /**
     * @return PaddleController|array The current PaddleController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaddleController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaddleController fields).
     */
    ...
    /**
     * Load a single PaddleController.
     *
     * @param PaddleControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PaddleControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PaddleController|array The loaded PaddleController as an assoc-array at the
    ...
    /**
     * Create a new PaddleController.
     *
     * @param PaddleControllerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PaddleControllerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PaddleController|array The created PaddleController as an assoc-array at the
     *   SDK boundary; throws IpGeolocationApi4Error on failure (item-5 convention).
     */
