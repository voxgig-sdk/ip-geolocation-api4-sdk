...
// IpGeolocationApi4 SDK UsageStatistic entity
...
class UsageStatisticEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UsageStatisticEntity($this->_client, $opts);
    }

    /**
     * @param UsageStatistic|array $args UsageStatistic data (assoc-array) to store.
     */
    ...
    /**
     * @return UsageStatistic|array The current UsageStatistic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UsageStatistic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UsageStatistic fields).
     */
    ...
    /**
     * Load a single UsageStatistic.
     *
     * @param UsageStatisticLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UsageStatisticLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UsageStatistic|array The loaded UsageStatistic as an assoc-array at the
