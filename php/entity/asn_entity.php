...
// IpGeolocationApi4 SDK Asn entity
...
class AsnEntity
{
     ...
     * Load a single Asn.
     *
     * @param AsnLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AsnLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Asn|array The loaded Asn as an assoc-array at the
