...
// IpGeolocationApi4 SDK Status entity
...
class StatusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StatusEntity($this->_client, $opts);
    }

    /**
     * @param Status|array $args Status data (assoc-array) to store.
     */
    ...
    /**
     * @return Status|array The current Status data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Status fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Status fields).
     */
    ...
    /**
     * Load a single Status.
     *
     * @param StatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Status|array The loaded Status as an assoc-array at the
