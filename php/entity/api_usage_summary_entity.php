...
// IpGeolocationApi4 SDK ApiUsageSummary entity
...
class ApiUsageSummaryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApiUsageSummaryEntity($this->_client, $opts);
    }

    /**
     * @param ApiUsageSummary|array $args ApiUsageSummary data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiUsageSummary|array The current ApiUsageSummary data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiUsageSummary fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiUsageSummary fields).
     */
    ...
    /**
     * Load a single ApiUsageSummary.
     *
     * @param ApiUsageSummaryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiUsageSummaryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiUsageSummary|array The loaded ApiUsageSummary as an assoc-array at the
