...
// IpGeolocationApi4 SDK Advanced entity
...
class AdvancedEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdvancedEntity($this->_client, $opts);
    }

    /**
     * @param Advanced|array $args Advanced data (assoc-array) to store.
     */
    ...
    /**
     * @return Advanced|array The current Advanced data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Advanced fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Advanced fields).
     */
    ...
    /**
     * Load a single Advanced.
     *
     * @param AdvancedLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdvancedLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Advanced|array The loaded Advanced as an assoc-array at the
