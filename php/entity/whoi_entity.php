...
// IpGeolocationApi4 SDK Whoi entity
...
class WhoiEntity
{
     ...
     * Load a single Whoi.
     *
     * @param WhoiLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WhoiLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Whoi|array The loaded Whoi as an assoc-array at the
