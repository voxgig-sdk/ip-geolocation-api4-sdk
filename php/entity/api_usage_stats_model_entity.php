...
// IpGeolocationApi4 SDK ApiUsageStatsModel entity
...
class ApiUsageStatsModelEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "api_usage_stats_model";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApiUsageStatsModelEntity($this->_client, $opts);
    }

    /**
     * @param ApiUsageStatsModel|array $args ApiUsageStatsModel data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiUsageStatsModel|array The current ApiUsageStatsModel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiUsageStatsModel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiUsageStatsModel fields).
     */
    ...
    /**
     * Load a single ApiUsageStatsModel.
     *
     * @param ApiUsageStatsModelLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiUsageStatsModelLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiUsageStatsModel|array The loaded ApiUsageStatsModel as an assoc-array at the
