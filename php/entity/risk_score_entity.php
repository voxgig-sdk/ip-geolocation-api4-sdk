...
// IpGeolocationApi4 SDK RiskScore entity
...
class RiskScoreEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RiskScoreEntity($this->_client, $opts);
    }

    /**
     * @param RiskScore|array $args RiskScore data (assoc-array) to store.
     */
    ...
    /**
     * @return RiskScore|array The current RiskScore data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RiskScore fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RiskScore fields).
     */
    ...
    /**
     * Load a single RiskScore.
     *
     * @param RiskScoreLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RiskScoreLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RiskScore|array The loaded RiskScore as an assoc-array at the
