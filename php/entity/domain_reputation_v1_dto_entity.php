...
// IpGeolocationApi4 SDK DomainReputationV1Dto entity
...
class DomainReputationV1DtoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "domain_reputation_v1_dto";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DomainReputationV1DtoEntity($this->_client, $opts);
    }

    /**
     * @param DomainReputationV1Dto|array $args DomainReputationV1Dto data (assoc-array) to store.
     */
    ...
    /**
     * @return DomainReputationV1Dto|array The current DomainReputationV1Dto data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DomainReputationV1Dto fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DomainReputationV1Dto fields).
     */
    ...
    /**
     * Load a single DomainReputationV1Dto.
     *
     * @param DomainReputationV1DtoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DomainReputationV1DtoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DomainReputationV1Dto|array The loaded DomainReputationV1Dto as an assoc-array at the
