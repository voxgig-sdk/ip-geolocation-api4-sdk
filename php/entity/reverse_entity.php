...
class ReverseEntity
{
     ...
     *
     * @param ReverseLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ReverseLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Reverse|array The loaded Reverse as an assoc-array at the
