...
class BatchEmailValidationResponseDtoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "batch_email_validation_response_dto";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new BatchEmailValidationResponseDtoEntity($this->_client, $opts);
    }

    /**
     * @param BatchEmailValidationResponseDto|array $args BatchEmailValidationResponseDto data (assoc-array) to store.
     */
    ...
    /**
     * @return BatchEmailValidationResponseDto|array The current BatchEmailValidationResponseDto data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BatchEmailValidationResponseDto fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BatchEmailValidationResponseDto fields).
     */
    ...
    /**
     * Create a new BatchEmailValidationResponseDto.
     *
     * @param BatchEmailValidationResponseDtoCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BatchEmailValidationResponseDtoCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BatchEmailValidationResponseDto|array The created BatchEmailValidationResponseDto as an assoc-array at the
