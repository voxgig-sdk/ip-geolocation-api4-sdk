...
// IpGeolocationApi4 SDK Forward entity
...
class ForwardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ForwardEntity($this->_client, $opts);
    }

    /**
     * @param Forward|array $args Forward data (assoc-array) to store.
     */
    ...
    /**
     * @return Forward|array The current Forward data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Forward fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Forward fields).
     */
    ...
    /**
     * Load a single Forward.
     *
     * @param ForwardLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ForwardLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Forward|array The loaded Forward as an assoc-array at the
