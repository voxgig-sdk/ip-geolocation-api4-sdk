...
// IpGeolocationApi4 SDK IpInfoV0 entity
...
class IpInfoV0Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new IpInfoV0Entity($this->_client, $opts);
    }

    /**
     * @param IpInfoV0|array $args IpInfoV0 data (assoc-array) to store.
     */
    ...
    /**
     * @return IpInfoV0|array The current IpInfoV0 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IpInfoV0 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IpInfoV0 fields).
     */
    ...
    /**
     * Load a single IpInfoV0.
     *
     * @param IpInfoV0LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IpInfoV0LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IpInfoV0|array The loaded IpInfoV0 as an assoc-array at the
