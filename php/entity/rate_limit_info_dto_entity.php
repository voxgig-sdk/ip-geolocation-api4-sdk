...
// IpGeolocationApi4 SDK RateLimitInfoDto entity
...
class RateLimitInfoDtoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "rate_limit_info_dto";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RateLimitInfoDtoEntity($this->_client, $opts);
    }

    /**
     * @param RateLimitInfoDto|array $args RateLimitInfoDto data (assoc-array) to store.
     */
    ...
    /**
     * @return RateLimitInfoDto|array The current RateLimitInfoDto data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RateLimitInfoDto fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RateLimitInfoDto fields).
     */
    ...
    /**
     * Load a single RateLimitInfoDto.
     *
     * @param RateLimitInfoDtoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RateLimitInfoDtoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RateLimitInfoDto|array The loaded RateLimitInfoDto as an assoc-array at the
