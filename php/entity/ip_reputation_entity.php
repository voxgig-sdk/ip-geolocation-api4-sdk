...
// IpGeolocationApi4 SDK IpReputation entity
...
class IpReputationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IpReputationEntity($this->_client, $opts);
    }

    /**
     * @param IpReputation|array $args IpReputation data (assoc-array) to store.
     */
    ...
    /**
     * @return IpReputation|array The current IpReputation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IpReputation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IpReputation fields).
     */
    ...
    /**
     * Load a single IpReputation.
     *
     * @param IpReputationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IpReputationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IpReputation|array The loaded IpReputation as an assoc-array at the
