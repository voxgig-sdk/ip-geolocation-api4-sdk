...
class Ipn2DirectTest extends TestCase
{
    public function test_direct_load_ipn2(): void
    {
        $setup = ipn2_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ipn2", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
