...
class CacheManagementDirectTest extends TestCase
{
    public function test_direct_load_cache_management(): void
    {
        $setup = cache_management_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-cache_management", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
