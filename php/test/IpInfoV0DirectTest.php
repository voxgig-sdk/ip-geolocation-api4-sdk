...
class IpInfoV0DirectTest extends TestCase
{
    public function test_direct_load_ip_info_v0(): void
    {
        $setup = ip_info_v0_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ip_info_v0", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
