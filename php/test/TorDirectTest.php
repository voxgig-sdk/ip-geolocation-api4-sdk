...
class TorDirectTest extends TestCase
{
    public function test_direct_load_tor(): void
    {
        $setup = tor_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-tor", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
