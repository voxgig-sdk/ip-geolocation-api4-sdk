...
class ApiUsageSummaryEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IPGEOLOCATIONAPI__TEST_API_USAGE_SUMMARY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function api_usage_summary_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IPGEOLOCATIONAPI__TEST_API_USAGE_SUMMARY_ENTID");
