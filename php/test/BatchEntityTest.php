...
class BatchEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IPGEOLOCATIONAPI__TEST_BATCH_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function batch_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IPGEOLOCATIONAPI__TEST_BATCH_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["IPGEOLOCATIONAPI__TEST_BATCH_ENTID"]);
