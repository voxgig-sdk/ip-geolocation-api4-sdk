...
class ApiUsageStatsModelEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IP_GEOLOCATION_API4_TEST_API_USAGE_STATS_MODEL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $api_usage_stats_model_ref01_data_dt0_load_result = Helpers::to_map(is_object($api_usage_stats_model_ref01_data_dt0_loaded) && method_exists($api_usage_stats_model_ref01_data_dt0_loaded, 'data_get') ? $api_usage_stats_model_ref01_data_dt0_loaded->data_get() : $api_usage_stats_model_ref01_data_dt0_loaded);
...
function api_usage_stats_model_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IP_GEOLOCATION_API4_TEST_API_USAGE_STATS_MODEL_ENTID");
