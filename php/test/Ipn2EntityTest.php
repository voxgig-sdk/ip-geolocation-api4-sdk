...
class Ipn2EntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IPGEOLOCATIONAPI__TEST_IPN__ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function ipn2_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IPGEOLOCATIONAPI__TEST_IPN__ENTID");
