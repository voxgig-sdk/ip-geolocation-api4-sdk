...
// IpGeolocationApi4 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpGeolocationApi4SDK::test)
...
{
    private const SDK_CLASS = 'IpGeolocationApi4SDK';
    ...
    private const SDK_BASE = 'ipgeolocationapi4_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipgeolocationapi4_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
