...
// IpGeolocationApi4 SDK audit feature
...
class IpGeolocationApi4AuditFeature extends IpGeolocationApi4BaseFeature
{
    ...
    private function _emit(IpGeolocationApi4Context $ctx, string $outcome): void
    {
