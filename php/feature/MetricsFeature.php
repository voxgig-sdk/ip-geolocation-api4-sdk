...
// IpGeolocationApi4 SDK metrics feature
...
class IpGeolocationApi4MetricsFeature extends IpGeolocationApi4BaseFeature
{
    ...
    private function _record(IpGeolocationApi4Context $ctx, bool $ok): void
    {
