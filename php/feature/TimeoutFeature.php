...
// IpGeolocationApi4 SDK timeout feature
...
class IpGeolocationApi4TimeoutFeature extends IpGeolocationApi4BaseFeature
{
    ...
    private function _with_timeout(IpGeolocationApi4Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpGeolocationApi4Context $_ctx, float $ms): void
    {
        $client = $this->client;
