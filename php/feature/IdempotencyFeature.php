...
// IpGeolocationApi4 SDK idempotency feature
...
class IpGeolocationApi4IdempotencyFeature extends IpGeolocationApi4BaseFeature
{
    ...
    private function _mutating(IpGeolocationApi4Context $ctx): bool
    {
