...
// IpGeolocationApi4 SDK ratelimit feature
...
class IpGeolocationApi4RatelimitFeature extends IpGeolocationApi4BaseFeature
{
    ...
    private function _acquire(IpGeolocationApi4Context $ctx): void
    {
    ...
    private function _track(IpGeolocationApi4Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
