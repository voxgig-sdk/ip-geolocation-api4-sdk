...
// IpGeolocationApi4 SDK proxy feature
...
class IpGeolocationApi4ProxyFeature extends IpGeolocationApi4BaseFeature
{
    ...
    public function init(IpGeolocationApi4Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpGeolocationApi4Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
