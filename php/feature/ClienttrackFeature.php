...
// IpGeolocationApi4 SDK clienttrack feature
...
class IpGeolocationApi4ClienttrackFeature extends IpGeolocationApi4BaseFeature
{
    ...
    public function PostConstruct(IpGeolocationApi4Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpGeolocationApi4-SDK';
