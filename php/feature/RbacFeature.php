...
// IpGeolocationApi4 SDK rbac feature
...
class IpGeolocationApi4RbacFeature extends IpGeolocationApi4BaseFeature
{
    ...
    private function _required(IpGeolocationApi4Context $ctx): ?string
    {
    ...
    private function _reject(IpGeolocationApi4Context $ctx, string $required): void
    {
    ...
    private function _track(IpGeolocationApi4Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
