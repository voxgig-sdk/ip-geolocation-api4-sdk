...
// IpGeolocationApi4 SDK netsim feature
...
class IpGeolocationApi4NetsimFeature extends IpGeolocationApi4BaseFeature
{
    ...
    private function _simulate(IpGeolocationApi4Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpGeolocationApi4Context $ctx, array $applied): void
    {
        $client = $this->client;
