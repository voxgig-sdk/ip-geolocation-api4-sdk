...
// IpGeolocationApi4 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IpGeolocationApi4TestFeature extends IpGeolocationApi4BaseFeature
{
    ...
    public function init(IpGeolocationApi4Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IpGeolocationApi4Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = IpGeolocationApi4Param::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IpGeolocationApi4Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IpGeolocationApi4Context $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = IpGeolocationApi4Param::call($ctx, $k);
