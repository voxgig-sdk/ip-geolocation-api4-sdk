...
// IpGeolocationApi4 SDK utility: fetcher

class IpGeolocationApi4Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpGeolocationApi4SDK/1.0)';
    ...
    public static function call(IpGeolocationApi4Context $ctx, string $fullurl, array $fetchdef): array
    {
