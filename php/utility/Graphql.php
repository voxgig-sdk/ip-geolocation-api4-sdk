...
// IpGeolocationApi4 SDK utility: graphql
//
...
class IpGeolocationApi4Graphql
{
    ...
    // equivalent.
    public static function body(IpGeolocationApi4Context $ctx): mixed
    {
    ...
    public static function errors(IpGeolocationApi4Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
