// Command IpGeolocationApi4-mcp is an MCP server exposing the IpGeolocationApi4
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpGeolocationApi4_list  — list records of an entity
//	IpGeolocationApi4_load  — load a single record of an entity
//
