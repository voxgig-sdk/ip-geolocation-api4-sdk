...
func registerSDKWords(r *eng.Registry, client *sdk.IpGeolocationApi4SDK) {
...
func runOp(client *sdk.IpGeolocationApi4SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
