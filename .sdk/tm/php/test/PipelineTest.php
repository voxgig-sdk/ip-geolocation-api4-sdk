...
// IpGeolocationApi4 SDK pipeline test
//
...
{
    private static function utility(): IpGeolocationApi4Utility
    {
        return new IpGeolocationApi4Utility();
    }
    ...
    private static function ctx(array $over = []): IpGeolocationApi4Context
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IpGeolocationApi4Context([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IpGeolocationApi4Operation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IpGeolocationApi4Error) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IpGeolocationApi4Operation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IpGeolocationApi4MakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IpGeolocationApi4Operation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IpGeolocationApi4MakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IpGeolocationApi4Operation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IpGeolocationApi4MakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpGeolocationApi4Spec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IpGeolocationApi4MakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IpGeolocationApi4Response([]),
            'result' => new IpGeolocationApi4Result([]),
        ]);
        [, $err] = IpGeolocationApi4MakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IpGeolocationApi4Spec([]),
            'response' => null,
            'result' => new IpGeolocationApi4Result([]),
        ]);
        [, $err] = IpGeolocationApi4MakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IpGeolocationApi4Spec(['step' => 's']),
            'response' => new IpGeolocationApi4Response(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IpGeolocationApi4Result([]),
        ]);
        [, $err] = IpGeolocationApi4MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IpGeolocationApi4Spec(['step' => 's']),
            'response' => new IpGeolocationApi4Response(self::resp(200, ['v' => 1])),
            'result' => new IpGeolocationApi4Result([]),
        ]);
        [, $err] = IpGeolocationApi4MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IpGeolocationApi4Spec(['step' => 's']),
            'response' => new IpGeolocationApi4Response(self::resp(200, ['v' => 2])),
            'result' => new IpGeolocationApi4Result([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IpGeolocationApi4MakeResponse::call($ctx);
    ...
    {
        $preset = new IpGeolocationApi4Response(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IpGeolocationApi4Spec([]),
            'response' => new IpGeolocationApi4Response([]),
            'result' => new IpGeolocationApi4Result([]),
        ...
        [$got, $err] = IpGeolocationApi4MakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IpGeolocationApi4Result([])]);
        [, $err] = IpGeolocationApi4MakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IpGeolocationApi4Spec([]), 'result' => null]);
        [, $err] = IpGeolocationApi4MakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpGeolocationApi4Spec(['step' => 's']),
            'result' => new IpGeolocationApi4Result(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IpGeolocationApi4Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpGeolocationApi4MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpGeolocationApi4Spec(['step' => 's']),
            'result' => new IpGeolocationApi4Result(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IpGeolocationApi4Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpGeolocationApi4MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpGeolocationApi4Result(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IpGeolocationApi4Spec([]),
            'result' => new IpGeolocationApi4Result([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IpGeolocationApi4MakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpGeolocationApi4MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IpGeolocationApi4Error('boom', 'boom');
        $utility->fetcher = function (IpGeolocationApi4Context $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpGeolocationApi4Spec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IpGeolocationApi4MakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IpGeolocationApi4Context $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IpGeolocationApi4MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IpGeolocationApi4Response::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        IpGeolocationApi4MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IpGeolocationApi4Context $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpGeolocationApi4Spec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IpGeolocationApi4MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IpGeolocationApi4Response(self::resp(201));
        $ctx = self::ctx(['spec' => new IpGeolocationApi4Spec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IpGeolocationApi4MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IpGeolocationApi4MakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IpGeolocationApi4MakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IpGeolocationApi4Result(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IpGeolocationApi4Done::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IpGeolocationApi4Result(['ok' => false])]);
        $this->expectException(IpGeolocationApi4Error::class);
        IpGeolocationApi4Done::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IpGeolocationApi4Result(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IpGeolocationApi4MakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IpGeolocationApi4MakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IpGeolocationApi4BaseFeature();
        $b = new IpGeolocationApi4BaseFeature();
        IpGeolocationApi4FeatureAdd::call($ctx, $a);
        IpGeolocationApi4FeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IpGeolocationApi4BaseFeature
    {
        $f = new IpGeolocationApi4BaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IpGeolocationApi4FeatureAdd::call($ctx, self::named_feature('a'));
        IpGeolocationApi4FeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        IpGeolocationApi4FeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        IpGeolocationApi4FeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        IpGeolocationApi4FeatureAdd::call($ctx, $replace);
        ...
        IpGeolocationApi4FeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IpGeolocationApi4Context
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IpGeolocationApi4Spec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpGeolocationApi4PrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        IpGeolocationApi4PrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IpGeolocationApi4Response(['headers' => null]),
            'result' => new IpGeolocationApi4Result([]),
        ]);
        IpGeolocationApi4ResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        IpGeolocationApi4ResultBody::call($ctx);
