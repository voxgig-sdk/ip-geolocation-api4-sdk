...
// IpGeolocationApi4 SDK utility type

class IpGeolocationApi4Utility
{
    ...
    public static function copy(IpGeolocationApi4Utility $src): IpGeolocationApi4Utility
    {
        $u = new IpGeolocationApi4Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
