...
// IpGeolocationApi4 SDK cache feature
...
class IpGeolocationApi4CacheFeature extends IpGeolocationApi4BaseFeature
{
    ...
    private function _through(IpGeolocationApi4Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
