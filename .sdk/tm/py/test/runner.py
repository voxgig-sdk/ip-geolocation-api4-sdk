...
class IpGeolocationApi4TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpGeolocationApi4TestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IpGeolocationApi4TestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IpGeolocationApi4TestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
