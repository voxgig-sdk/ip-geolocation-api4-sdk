...
from projectname_sdk import IpGeolocationApi4SDK
from projectname_sdk.core.spec import IpGeolocationApi4Spec
from projectname_sdk.core.result import IpGeolocationApi4Result
from projectname_sdk.core.response import IpGeolocationApi4Response
from projectname_sdk.core.operation import IpGeolocationApi4Operation
from projectname_sdk.core.error import IpGeolocationApi4Error
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import IpGeolocationApi4BaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return IpGeolocationApi4Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = IpGeolocationApi4SDK.test(None, None)
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except IpGeolocationApi4Error as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = IpGeolocationApi4Result({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = IpGeolocationApi4SDK.test(None, None)
        ...
        class TestInitFeature(IpGeolocationApi4BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(IpGeolocationApi4BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = IpGeolocationApi4SDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = IpGeolocationApi4SDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = IpGeolocationApi4Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IpGeolocationApi4SDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = IpGeolocationApi4Operation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IpGeolocationApi4SDK.test(None, setup_opts)
