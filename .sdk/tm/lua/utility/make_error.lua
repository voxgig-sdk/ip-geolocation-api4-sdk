...
local function make_error_util(ctx, err)
  ...
  local msg = "IpGeolocationApi4SDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = IpGeolocationApi4Error.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == IpGeolocationApi4Error then
