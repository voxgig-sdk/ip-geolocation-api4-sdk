...
const SDK_NAME = 'IpGeolocationApi4SDK'
...
const TEST_SEED = {"entity":{"advanced":{"test01":{"id":"test01"}},"api_usage_stats_model":{"test01":{"id":"test01"}},"api_usage_summary":{"test01":{"id":"test01"}},"asn":{"test01":{"id":"test01"}},"batch":{"test01":{"id":"test01"}},"batch_email_validation_response_dto":{"test01":{"id":"test01"}},"cache_management":{"test01":{"id":"test01"}},"domain_analysi":{"test01":{"id":"test01"}},"domain_reputation_v1_dto":{"test01":{"id":"test01"}},"email":{"test01":{"id":"test01"}},"forward":{"test01":{"id":"test01"}},"ip_info_v0":{"test01":{"id":"test01"}},"ip_reputation":{"test01":{"id":"test01"}},"ipn":{"test01":{"id":"test01"}},"ipn2":{"test01":{"id":"test01"}},"mxn":{"test01":{"id":"test01"}},"paddle_controller":{"test01":{"id":"test01"}},"rate_limit_info_dto":{"test01":{"id":"test01"}},"reverse":{"test01":{"id":"test01"}},"risk_score":{"test01":{"id":"test01"}},"status":{"test01":{"id":"test01"}},"tor":{"test01":{"id":"test01"}},"usage_statistic":{"test01":{"id":"test01"}},"whoi":{"test01":{"id":"test01"}}}}
...
function isRunnable(code: string): boolean {
  return (
    /new\s+IpGeolocationApi4SDK\b/.test(code) ||
    /\bIpGeolocationApi4SDK\.test\b/.test(code) ||
    /\bclient\s*\./.test(code)
  )
}
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+IpGeolocationApi4SDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/IpGeolocationApi4SDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
