...
describe('ApiUsageSummaryDirect', async () => {
  ...
  test('direct-load-api_usage_summary', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-api_usage_summary', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['IP_GEOLOCATION_API4_TEST_API_USAGE_SUMMARY_ENTID']
