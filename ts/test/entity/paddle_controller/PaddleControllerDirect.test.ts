...
describe('PaddleControllerDirect', async () => {
  ...
  test('direct-load-paddle_controller', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-paddle_controller', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['IP_GEOLOCATION_API4_TEST_PADDLE_CONTROLLER_ENTID']
