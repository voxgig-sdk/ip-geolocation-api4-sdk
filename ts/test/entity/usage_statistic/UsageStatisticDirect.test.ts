...
describe('UsageStatisticDirect', async () => {
  ...
  test('direct-load-usage_statistic', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-usage_statistic', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['IP_GEOLOCATION_API4_TEST_USAGE_STATISTIC_ENTID']
