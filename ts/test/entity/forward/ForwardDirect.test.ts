...
describe('ForwardDirect', async () => {
  ...
  test('direct-load-forward', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-forward', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['IP_GEOLOCATION_API4_TEST_FORWARD_ENTID']
