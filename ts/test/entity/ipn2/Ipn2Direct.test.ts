...
describe('Ipn2Direct', async () => {
  ...
  test('direct-load-ipn2', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-ipn2', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['IPGEOLOCATIONAPI__TEST_IPN__ENTID']
