...
describe('ApiUsageStatsModelDirect', async () => {
  ...
  test('direct-load-api_usage_stats_model', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-api_usage_stats_model', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['IP_GEOLOCATION_API4_TEST_API_USAGE_STATS_MODEL_ENTID']
