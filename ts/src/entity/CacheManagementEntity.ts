...
import type {
  CacheManagement,
  CacheManagementLoadMatch,
  CacheManagementRemoveMatch,
} from '../IpGeolocationApi4Types'

// TODO: needs Entity superclass
class CacheManagementEntity extends IpGeolocationApi4EntityBase<CacheManagement> {

  constructor(client: IpGeolocationApi4SDK, entopts: any) {
    super(client, entopts)
    this.name = 'cache_management'
    this.name_ = 'cache_management'
    this.Name = 'CacheManagement'
  }


  make(this: CacheManagementEntity) {
    return new CacheManagementEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: CacheManagementLoadMatch, ctrl?: Control): Promise<CacheManagementEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<CacheManagement> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: CacheManagementRemoveMatch, ctrl?: Control,
  ): Promise<CacheManagementEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<CacheManagementEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
