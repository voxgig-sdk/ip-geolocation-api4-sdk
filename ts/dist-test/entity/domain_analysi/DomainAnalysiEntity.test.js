...
(0, node_test_1.describe)('DomainAnalysiEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'domain_analysi.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != domain_analysi_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/domain_analysi/DomainAnalysiTestData.json');
    ...
    let idmap = transform(['domain_analysi01', 'domain_analysi02', 'domain_analysi03', 'age01', 'age02', 'age03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IP_GEOLOCATION_API4_TEST_DOMAIN_ANALYSI_ENTID'];
...
//# sourceMappingURL=DomainAnalysiEntity.test.js.map