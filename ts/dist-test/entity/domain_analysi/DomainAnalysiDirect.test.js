...
(0, node_test_1.describe)('DomainAnalysiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-domain_analysi', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-domain_analysi', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_DOMAIN_ANALYSI_ENTID'];
...
//# sourceMappingURL=DomainAnalysiDirect.test.js.map