...
(0, node_test_1.describe)('AdvancedEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'advanced.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set IP_GEOLOCATION_API4_TEST_ADVANCED_ENTID JSON to run live');
            return;
        }
        ...
        let advanced_ref01_data = Object.values(setup.data.existing.advanced)[0];
        // LOAD
        const advanced_ref01_ent = client.Advanced();
        const advanced_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(advanced_ref01_data_dt0.id === advanced_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['IP_GEOLOCATION_API4_TEST_ADVANCED_ENTID'];
