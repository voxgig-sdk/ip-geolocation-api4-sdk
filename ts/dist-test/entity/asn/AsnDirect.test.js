...
(0, node_test_1.describe)('AsnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-asn', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-asn', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_ASN_ENTID'];
