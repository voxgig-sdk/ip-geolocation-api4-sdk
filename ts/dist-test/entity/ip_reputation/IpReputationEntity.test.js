...
(0, node_test_1.describe)('IpReputationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'ip_reputation.' + op, live))
                return;
        }
        ...
        let ip_reputation_ref01_data = Object.values(setup.data.existing.ip_reputation)[0];
        // LOAD
        const ip_reputation_ref01_ent = client.IpReputation();
        const ip_reputation_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(ip_reputation_ref01_data_dt0.id === ip_reputation_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/ip_reputation/IpReputationTestData.json');
    ...
    let idmap = transform(['ip_reputation01', 'ip_reputation02', 'ip_reputation03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IP_GEOLOCATION_API4_TEST_IP_REPUTATION_ENTID'];
    ...
    idmap = env['IP_GEOLOCATION_API4_TEST_IP_REPUTATION_ENTID'];
...
//# sourceMappingURL=IpReputationEntity.test.js.map