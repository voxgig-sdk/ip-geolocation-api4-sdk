...
(0, node_test_1.describe)('IpReputationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IpGeolocationApi4SDK({
    ...
    (0, node_test_1.test)('direct-load-ip_reputation', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ip_reputation', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'IP_GEOLOCATION_API4_TEST_IP_REPUTATION_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.IpGeolocationApi4SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['IP_GEOLOCATION_API4_TEST_IP_REPUTATION_ENTID'];
    ...
    const client = new __1.IpGeolocationApi4SDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=IpReputationDirect.test.js.map