...
(0, node_test_1.describe)('WhoiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-whoi', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-whoi', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'IP_GEOLOCATION_API4_TEST_WHOI_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_WHOI_ENTID'];
