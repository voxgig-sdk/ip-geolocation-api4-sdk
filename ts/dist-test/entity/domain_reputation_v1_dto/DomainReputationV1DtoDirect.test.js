...
(0, node_test_1.describe)('DomainReputationV1DtoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-domain_reputation_v1_dto', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-domain_reputation_v1_dto', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_DOMAIN_REPUTATION_V1_DTO_ENTID'];
...
//# sourceMappingURL=DomainReputationV1DtoDirect.test.js.map