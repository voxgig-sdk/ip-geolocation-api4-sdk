...
(0, node_test_1.describe)('ReverseEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'reverse.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set IP_GEOLOCATION_API4_TEST_REVERSE_ENTID JSON to run live');
            return;
        }
        ...
        let reverse_ref01_data = Object.values(setup.data.existing.reverse)[0];
        // LOAD
        const reverse_ref01_ent = client.Reverse();
        const reverse_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(reverse_ref01_data_dt0.id === reverse_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/reverse/ReverseTestData.json');
    ...
    let idmap = transform(['reverse01', 'reverse02', 'reverse03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IP_GEOLOCATION_API4_TEST_REVERSE_ENTID'];
...
//# sourceMappingURL=ReverseEntity.test.js.map