...
(0, node_test_1.describe)('ReverseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-reverse', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-reverse', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_REVERSE_ENTID'];
...
//# sourceMappingURL=ReverseDirect.test.js.map