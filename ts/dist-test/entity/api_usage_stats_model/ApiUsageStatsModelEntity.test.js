...
(0, node_test_1.describe)('ApiUsageStatsModelEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let api_usage_stats_model_ref01_data = Object.values(setup.data.existing.api_usage_stats_model)[0];
        // LOAD
        const api_usage_stats_model_ref01_ent = client.ApiUsageStatsModel();
        const api_usage_stats_model_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(api_usage_stats_model_ref01_data_dt0.id === api_usage_stats_model_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_usage_stats_model/ApiUsageStatsModelTestData.json');
    ...
    let idmap = transform(['api_usage_stats_model01', 'api_usage_stats_model02', 'api_usage_stats_model03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ApiUsageStatsModelEntity.test.js.map