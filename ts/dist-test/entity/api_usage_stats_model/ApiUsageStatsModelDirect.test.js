...
(0, node_test_1.describe)('ApiUsageStatsModelDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_usage_stats_model', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_usage_stats_model', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_API_USAGE_STATS_MODEL_ENTID'];
...
//# sourceMappingURL=ApiUsageStatsModelDirect.test.js.map