...
(0, node_test_1.describe)('PaddleControllerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-paddle_controller', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-paddle_controller', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_PADDLE_CONTROLLER_ENTID'];
...
//# sourceMappingURL=PaddleControllerDirect.test.js.map