...
(0, node_test_1.describe)('PaddleControllerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'paddle_controller.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != paddle_controller_ref01_data);
        // LOAD
        const paddle_controller_ref01_match_dt0 = {};
        const paddle_controller_ref01_data_dt0 = (await paddle_controller_ref01_ent.load(paddle_controller_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != paddle_controller_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/paddle_controller/PaddleControllerTestData.json');
    ...
    let idmap = transform(['paddle_controller01', 'paddle_controller02', 'paddle_controller03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PaddleControllerEntity.test.js.map