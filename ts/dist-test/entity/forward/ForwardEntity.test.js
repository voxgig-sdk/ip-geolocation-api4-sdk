...
(0, node_test_1.describe)('ForwardEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'forward.' + op, live))
                return;
        }
        ...
        let forward_ref01_data = Object.values(setup.data.existing.forward)[0];
        // LOAD
        const forward_ref01_ent = client.Forward();
        const forward_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(forward_ref01_data_dt0.id === forward_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/forward/ForwardTestData.json');
    ...
    let idmap = transform(['forward01', 'forward02', 'forward03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IP_GEOLOCATION_API4_TEST_FORWARD_ENTID'];
...
//# sourceMappingURL=ForwardEntity.test.js.map