...
(0, node_test_1.describe)('IpInfoV0Direct', async () => {
    ...
    (0, node_test_1.test)('direct-load-ip_info_v0', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ip_info_v0', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_IP_INFO_V0_ENTID'];
...
//# sourceMappingURL=IpInfoV0Direct.test.js.map