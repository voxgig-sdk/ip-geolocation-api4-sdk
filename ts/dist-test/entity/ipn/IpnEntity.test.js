...
(0, node_test_1.describe)('IpnEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set IP_GEOLOCATION_API4_TEST_IPN_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['ipn01', 'ipn02', 'ipn03', 'ip01', 'ip02', 'ip03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IP_GEOLOCATION_API4_TEST_IPN_ENTID'];
    ...
    idmap = env['IP_GEOLOCATION_API4_TEST_IPN_ENTID'];
