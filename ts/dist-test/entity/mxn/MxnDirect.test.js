...
(0, node_test_1.describe)('MxnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-mxn', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-mxn', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_MXN_ENTID'];
...
//# sourceMappingURL=MxnDirect.test.js.map