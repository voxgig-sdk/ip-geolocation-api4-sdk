...
(0, node_test_1.describe)('MxnEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'mxn.' + op, live))
                return;
        }
        ...
        let mxn_ref01_data = Object.values(setup.data.existing.mxn)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/mxn/MxnTestData.json');
    ...
    let idmap = transform(['mxn01', 'mxn02', 'mxn03', 'mx01', 'mx02', 'mx03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IP_GEOLOCATION_API4_TEST_MXN_ENTID'];
...
//# sourceMappingURL=MxnEntity.test.js.map