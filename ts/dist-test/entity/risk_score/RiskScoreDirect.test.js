...
(0, node_test_1.describe)('RiskScoreDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-risk_score', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-risk_score', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_RISK_SCORE_ENTID'];
...
//# sourceMappingURL=RiskScoreDirect.test.js.map