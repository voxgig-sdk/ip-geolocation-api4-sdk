...
(0, node_test_1.describe)('StatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-status', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-status', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'IP_GEOLOCATION_API4_TEST_STATUS_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_STATUS_ENTID'];
...
//# sourceMappingURL=StatusDirect.test.js.map