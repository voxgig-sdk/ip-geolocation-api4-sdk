...
(0, node_test_1.describe)('TorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-tor', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-tor', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_TOR_ENTID'];
...
//# sourceMappingURL=TorDirect.test.js.map