...
(0, node_test_1.describe)('EmailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-email', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-email', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            params.id = "john.doe@company.com";
        }
        else {
            params.id = 'direct01';
        }
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'IP_GEOLOCATION_API4_TEST_EMAIL_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_EMAIL_ENTID'];
...
//# sourceMappingURL=EmailDirect.test.js.map