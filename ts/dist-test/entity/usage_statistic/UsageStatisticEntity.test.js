...
(0, node_test_1.describe)('UsageStatisticEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'usage_statistic.' + op, live))
                return;
        }
        ...
        let usage_statistic_ref01_data = Object.values(setup.data.existing.usage_statistic)[0];
        // LOAD
        const usage_statistic_ref01_ent = client.UsageStatistic();
        const usage_statistic_ref01_match_dt0 = {};
        const usage_statistic_ref01_data_dt0 = (await usage_statistic_ref01_ent.load(usage_statistic_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != usage_statistic_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/usage_statistic/UsageStatisticTestData.json');
    ...
    let idmap = transform(['usage_statistic01', 'usage_statistic02', 'usage_statistic03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IP_GEOLOCATION_API4_TEST_USAGE_STATISTIC_ENTID'];
...
//# sourceMappingURL=UsageStatisticEntity.test.js.map