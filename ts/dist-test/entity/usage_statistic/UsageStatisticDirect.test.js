...
(0, node_test_1.describe)('UsageStatisticDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-usage_statistic', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-usage_statistic', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_USAGE_STATISTIC_ENTID'];
...
//# sourceMappingURL=UsageStatisticDirect.test.js.map