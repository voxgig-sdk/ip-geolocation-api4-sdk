...
(0, node_test_1.describe)('CacheManagementDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-cache_management', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-cache_management', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_CACHE_MANAGEMENT_ENTID'];
...
//# sourceMappingURL=CacheManagementDirect.test.js.map