...
(0, node_test_1.describe)('RateLimitInfoDtoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-rate_limit_info_dto', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-rate_limit_info_dto', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API4_TEST_RATE_LIMIT_INFO_DTO_ENTID'];
...
//# sourceMappingURL=RateLimitInfoDtoDirect.test.js.map