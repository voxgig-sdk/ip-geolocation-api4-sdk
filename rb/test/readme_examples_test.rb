...
#      offline in seeded test mode (IpGeolocationApi4SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IpGeolocationApi4_sdk.rb")
  SDK_CLASS = "IpGeolocationApi4SDK"
  ...
  SDK_BASE = "IpGeolocationApi4_sdk"
