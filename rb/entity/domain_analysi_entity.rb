...
class DomainAnalysiEntity
  ...
  def make
    opts = @_entopts.dup
    DomainAnalysiEntity.new(@_client, opts)
  end
  ...
  # @return [DomainAnalysi, Hash] the current DomainAnalysi data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DomainAnalysi fields)
  def match_get
  ...
  #
  # @param reqmatch [DomainAnalysiLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DomainAnalysi.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DomainAnalysi, Hash] the loaded DomainAnalysi; raises IpGeolocationApi4Error on failure
  ...
  #
  # @param reqdata [DomainAnalysiCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [DomainAnalysi, Hash] the created DomainAnalysi; raises IpGeolocationApi4Error on failure
