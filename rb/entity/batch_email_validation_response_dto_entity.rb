...
class BatchEmailValidationResponseDtoEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "batch_email_validation_response_dto"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    BatchEmailValidationResponseDtoEntity.new(@_client, opts)
  end
  ...
  # @return [BatchEmailValidationResponseDto, Hash] the current BatchEmailValidationResponseDto data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of BatchEmailValidationResponseDto fields)
  def match_get
  ...
  #
  # @param reqdata [BatchEmailValidationResponseDtoCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [BatchEmailValidationResponseDto, Hash] the created BatchEmailValidationResponseDto; raises IpGeolocationApi4Error on failure
