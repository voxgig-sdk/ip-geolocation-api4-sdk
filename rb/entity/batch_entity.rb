# IpGeolocationApi4 SDK Batch entity
...
class BatchEntity
  ...
  # Create a new Batch.
  #
  # @param reqdata [BatchCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Batch, Hash] the created Batch; raises IpGeolocationApi4Error on failure
