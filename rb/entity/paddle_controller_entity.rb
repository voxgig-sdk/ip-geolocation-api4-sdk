...
class PaddleControllerEntity
  ...
  def make
    opts = @_entopts.dup
    PaddleControllerEntity.new(@_client, opts)
  end
  ...
  # @return [PaddleController, Hash] the current PaddleController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaddleController fields)
  def match_get
  ...
  #
  # @param reqmatch [PaddleControllerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PaddleController.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaddleController, Hash] the loaded PaddleController; raises IpGeolocationApi4Error on failure
  ...
  #
  # @param reqdata [PaddleControllerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaddleController, Hash] the created PaddleController; raises IpGeolocationApi4Error on failure
