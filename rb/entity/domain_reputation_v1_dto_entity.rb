...
class DomainReputationV1DtoEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "domain_reputation_v1_dto"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    DomainReputationV1DtoEntity.new(@_client, opts)
  end
  ...
  # @return [DomainReputationV1Dto, Hash] the current DomainReputationV1Dto data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DomainReputationV1Dto fields)
  def match_get
  ...
  #
  # @param reqmatch [DomainReputationV1DtoLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DomainReputationV1Dto.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DomainReputationV1Dto, Hash] the loaded DomainReputationV1Dto; raises IpGeolocationApi4Error on failure
