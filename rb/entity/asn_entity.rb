...
class AsnEntity
  ...
  # Load a single Asn.
  #
  # @param reqmatch [AsnLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Asn.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Asn, Hash] the loaded Asn; raises IpGeolocationApi4Error on failure
