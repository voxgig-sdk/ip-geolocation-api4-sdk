...
class ReverseEntity
  ...
  def make
    opts = @_entopts.dup
    ReverseEntity.new(@_client, opts)
  end
  ...
  # @return [Reverse, Hash] the current Reverse data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Reverse fields)
  def match_get
  ...
  # Load a single Reverse.
  #
  # @param reqmatch [ReverseLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Reverse.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Reverse, Hash] the loaded Reverse; raises IpGeolocationApi4Error on failure
