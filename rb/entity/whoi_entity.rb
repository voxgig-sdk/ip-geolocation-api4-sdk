...
class WhoiEntity
  ...
  # Load a single Whoi.
  #
  # @param reqmatch [WhoiLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Whoi.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Whoi, Hash] the loaded Whoi; raises IpGeolocationApi4Error on failure
