...
class AdvancedEntity
  ...
  def make
    opts = @_entopts.dup
    AdvancedEntity.new(@_client, opts)
  end
  ...
  # @return [Advanced, Hash] the current Advanced data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Advanced fields)
  def match_get
  ...
  #
  # @param reqmatch [AdvancedLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Advanced.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Advanced, Hash] the loaded Advanced; raises IpGeolocationApi4Error on failure
