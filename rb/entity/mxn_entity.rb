...
class MxnEntity
  ...
  # @return [Mxn, Hash] the current Mxn data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Mxn fields)
  def match_get
  ...
  # Load a single Mxn.
  #
  # @param reqmatch [MxnLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Mxn.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Mxn, Hash] the loaded Mxn; raises IpGeolocationApi4Error on failure
