...
class Ipn2Entity
  ...
  # @return [Ipn2, Hash] the current Ipn2 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Ipn2 fields)
  def match_get
  ...
  # @return [Ipn2, Hash] the loaded Ipn2; raises IpGeolocationApi4Error on failure
