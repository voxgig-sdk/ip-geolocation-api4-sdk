...
class TorEntity
  ...
  # @return [Tor, Hash] the current Tor data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Tor fields)
  def match_get
  ...
  # Load a single Tor.
  #
  # @param reqmatch [TorLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Tor.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Tor, Hash] the loaded Tor; raises IpGeolocationApi4Error on failure
