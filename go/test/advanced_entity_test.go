...
func TestAdvancedEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		advancedRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.advanced")))
...
func advancedBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("IP_GEOLOCATION_API4_TEST_ADVANCED_ENTID")
	...
	idmapResolved := core.ToMapAny(env["IP_GEOLOCATION_API4_TEST_ADVANCED_ENTID"])
