...
func TestReverseEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		reverseRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.reverse")))
...
func reverseBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("IP_GEOLOCATION_API4_TEST_REVERSE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["IP_GEOLOCATION_API4_TEST_REVERSE_ENTID"])
