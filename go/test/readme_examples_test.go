...
const testSeed = `map[string]any{"entity": map[string]any{"advanced": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "api_usage_stats_model": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "api_usage_summary": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "asn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "batch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "batch_email_validation_response_dto": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cache_management": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "domain_analysi": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "domain_reputation_v1_dto": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "forward": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ip_info_v0": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ip_reputation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ipn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ipn2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mxn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "paddle_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rate_limit_info_dto": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reverse": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "risk_score": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "usage_statistic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whoi": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
