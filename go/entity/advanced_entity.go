...
func NewAdvancedEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *AdvancedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdvancedEntity) GetName() string { return e.name }
...
func (e *AdvancedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdvancedEntity) Deleted() bool {
	return e.deleted
}


func (e *AdvancedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdvancedEntity(e.client, opts)
}

func (e *AdvancedEntity) Data(args ...any) any {
...
func (e *AdvancedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Advanced; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdvancedEntity) DataTyped(data ...Advanced) Advanced {
	if len(data) > 0 {
		return typedFrom[Advanced](e.Data(asMap(data[0])))
	}
	return typedFrom[Advanced](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Advanced (all fields
// optional at the wire level).
func (e *AdvancedEntity) MatchTyped(match ...Advanced) Advanced {
	if len(match) > 0 {
		return typedFrom[Advanced](e.Match(asMap(match[0])))
	}
	return typedFrom[Advanced](e.Match())
}
...
func (e *AdvancedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdvancedEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdvancedLoadMatch and returns an Advanced. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AdvancedEntity) LoadTyped(reqmatch AdvancedLoadMatch, ctrl map[string]any) (Advanced, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Advanced{}, err
	}
	return typedFrom[Advanced](res), nil
}



func (e *AdvancedEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AdvancedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AdvancedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdvancedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdvancedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
