...
func NewRiskScoreEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *RiskScoreEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RiskScoreEntity) GetName() string { return e.name }
...
func (e *RiskScoreEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RiskScoreEntity) Deleted() bool {
	return e.deleted
}


func (e *RiskScoreEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRiskScoreEntity(e.client, opts)
}

func (e *RiskScoreEntity) Data(args ...any) any {
...
func (e *RiskScoreEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RiskScore; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RiskScoreEntity) DataTyped(data ...RiskScore) RiskScore {
	if len(data) > 0 {
		return typedFrom[RiskScore](e.Data(asMap(data[0])))
	}
	return typedFrom[RiskScore](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RiskScore (all fields
// optional at the wire level).
func (e *RiskScoreEntity) MatchTyped(match ...RiskScore) RiskScore {
	if len(match) > 0 {
		return typedFrom[RiskScore](e.Match(asMap(match[0])))
	}
	return typedFrom[RiskScore](e.Match())
}
...
func (e *RiskScoreEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RiskScoreEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RiskScoreLoadMatch and returns an RiskScore. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RiskScoreEntity) LoadTyped(reqmatch RiskScoreLoadMatch, ctrl map[string]any) (RiskScore, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RiskScore{}, err
	}
	return typedFrom[RiskScore](res), nil
}



func (e *RiskScoreEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RiskScoreEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RiskScoreEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RiskScoreEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RiskScoreEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
