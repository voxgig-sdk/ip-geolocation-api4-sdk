...
type IpReputationEntity struct {
	name    string
...
func NewIpReputationEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *IpReputationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IpReputationEntity) GetName() string { return e.name }
...
func (e *IpReputationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IpReputationEntity) Deleted() bool {
	return e.deleted
}


func (e *IpReputationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIpReputationEntity(e.client, opts)
}

func (e *IpReputationEntity) Data(args ...any) any {
...
func (e *IpReputationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IpReputation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IpReputationEntity) DataTyped(data ...IpReputation) IpReputation {
	if len(data) > 0 {
		return typedFrom[IpReputation](e.Data(asMap(data[0])))
	}
	return typedFrom[IpReputation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IpReputation (all fields
// optional at the wire level).
func (e *IpReputationEntity) MatchTyped(match ...IpReputation) IpReputation {
	if len(match) > 0 {
		return typedFrom[IpReputation](e.Match(asMap(match[0])))
	}
	return typedFrom[IpReputation](e.Match())
}
...
func (e *IpReputationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IpReputationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IpReputationLoadMatch and returns an IpReputation. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IpReputationEntity) LoadTyped(reqmatch IpReputationLoadMatch, ctrl map[string]any) (IpReputation, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return IpReputation{}, err
	}
	return typedFrom[IpReputation](res), nil
}



func (e *IpReputationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IpReputationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IpReputationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IpReputationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IpReputationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
