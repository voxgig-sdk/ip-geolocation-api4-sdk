...
func NewForwardEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *ForwardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ForwardEntity) GetName() string { return e.name }
...
func (e *ForwardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ForwardEntity) Deleted() bool {
	return e.deleted
}


func (e *ForwardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewForwardEntity(e.client, opts)
}

func (e *ForwardEntity) Data(args ...any) any {
...
func (e *ForwardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Forward; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ForwardEntity) DataTyped(data ...Forward) Forward {
	if len(data) > 0 {
		return typedFrom[Forward](e.Data(asMap(data[0])))
	}
	return typedFrom[Forward](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Forward (all fields
// optional at the wire level).
func (e *ForwardEntity) MatchTyped(match ...Forward) Forward {
	if len(match) > 0 {
		return typedFrom[Forward](e.Match(asMap(match[0])))
	}
	return typedFrom[Forward](e.Match())
}
...
func (e *ForwardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ForwardEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ForwardLoadMatch and returns an Forward. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ForwardEntity) LoadTyped(reqmatch ForwardLoadMatch, ctrl map[string]any) (Forward, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Forward{}, err
	}
	return typedFrom[Forward](res), nil
}



func (e *ForwardEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ForwardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ForwardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ForwardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ForwardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
