...
type RateLimitInfoDtoEntity struct {
	name    string
...
func NewRateLimitInfoDtoEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *RateLimitInfoDtoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RateLimitInfoDtoEntity) GetName() string { return e.name }
...
func (e *RateLimitInfoDtoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RateLimitInfoDtoEntity) Deleted() bool {
	return e.deleted
}


func (e *RateLimitInfoDtoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRateLimitInfoDtoEntity(e.client, opts)
}

func (e *RateLimitInfoDtoEntity) Data(args ...any) any {
...
func (e *RateLimitInfoDtoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RateLimitInfoDto; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RateLimitInfoDtoEntity) DataTyped(data ...RateLimitInfoDto) RateLimitInfoDto {
	if len(data) > 0 {
		return typedFrom[RateLimitInfoDto](e.Data(asMap(data[0])))
	}
	return typedFrom[RateLimitInfoDto](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RateLimitInfoDto (all fields
// optional at the wire level).
func (e *RateLimitInfoDtoEntity) MatchTyped(match ...RateLimitInfoDto) RateLimitInfoDto {
	if len(match) > 0 {
		return typedFrom[RateLimitInfoDto](e.Match(asMap(match[0])))
	}
	return typedFrom[RateLimitInfoDto](e.Match())
}
...
func (e *RateLimitInfoDtoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RateLimitInfoDtoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RateLimitInfoDtoLoadMatch and returns an RateLimitInfoDto. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RateLimitInfoDtoEntity) LoadTyped(reqmatch RateLimitInfoDtoLoadMatch, ctrl map[string]any) (RateLimitInfoDto, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RateLimitInfoDto{}, err
	}
	return typedFrom[RateLimitInfoDto](res), nil
}



func (e *RateLimitInfoDtoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RateLimitInfoDtoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RateLimitInfoDtoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RateLimitInfoDtoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RateLimitInfoDtoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
