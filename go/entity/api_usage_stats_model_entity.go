...
type ApiUsageStatsModelEntity struct {
	name    string
...
func NewApiUsageStatsModelEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *ApiUsageStatsModelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ApiUsageStatsModelEntity) GetName() string { return e.name }
...
func (e *ApiUsageStatsModelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApiUsageStatsModelEntity) Deleted() bool {
	return e.deleted
}


func (e *ApiUsageStatsModelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewApiUsageStatsModelEntity(e.client, opts)
}

func (e *ApiUsageStatsModelEntity) Data(args ...any) any {
...
func (e *ApiUsageStatsModelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ApiUsageStatsModel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ApiUsageStatsModelEntity) DataTyped(data ...ApiUsageStatsModel) ApiUsageStatsModel {
	if len(data) > 0 {
		return typedFrom[ApiUsageStatsModel](e.Data(asMap(data[0])))
	}
	return typedFrom[ApiUsageStatsModel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ApiUsageStatsModel (all fields
// optional at the wire level).
func (e *ApiUsageStatsModelEntity) MatchTyped(match ...ApiUsageStatsModel) ApiUsageStatsModel {
	if len(match) > 0 {
		return typedFrom[ApiUsageStatsModel](e.Match(asMap(match[0])))
	}
	return typedFrom[ApiUsageStatsModel](e.Match())
}
...
func (e *ApiUsageStatsModelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ApiUsageStatsModelEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ApiUsageStatsModelLoadMatch and returns an ApiUsageStatsModel. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ApiUsageStatsModelEntity) LoadTyped(reqmatch ApiUsageStatsModelLoadMatch, ctrl map[string]any) (ApiUsageStatsModel, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ApiUsageStatsModel{}, err
	}
	return typedFrom[ApiUsageStatsModel](res), nil
}



func (e *ApiUsageStatsModelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ApiUsageStatsModelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ApiUsageStatsModelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ApiUsageStatsModelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ApiUsageStatsModelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
