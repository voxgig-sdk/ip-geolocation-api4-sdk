...
type UsageStatisticEntity struct {
	name    string
...
func NewUsageStatisticEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *UsageStatisticEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UsageStatisticEntity) GetName() string { return e.name }
...
func (e *UsageStatisticEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UsageStatisticEntity) Deleted() bool {
	return e.deleted
}


func (e *UsageStatisticEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUsageStatisticEntity(e.client, opts)
}

func (e *UsageStatisticEntity) Data(args ...any) any {
...
func (e *UsageStatisticEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UsageStatistic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UsageStatisticEntity) DataTyped(data ...UsageStatistic) UsageStatistic {
	if len(data) > 0 {
		return typedFrom[UsageStatistic](e.Data(asMap(data[0])))
	}
	return typedFrom[UsageStatistic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UsageStatistic (all fields
// optional at the wire level).
func (e *UsageStatisticEntity) MatchTyped(match ...UsageStatistic) UsageStatistic {
	if len(match) > 0 {
		return typedFrom[UsageStatistic](e.Match(asMap(match[0])))
	}
	return typedFrom[UsageStatistic](e.Match())
}
...
func (e *UsageStatisticEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UsageStatisticEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UsageStatisticLoadMatch and returns an UsageStatistic. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UsageStatisticEntity) LoadTyped(reqmatch UsageStatisticLoadMatch, ctrl map[string]any) (UsageStatistic, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UsageStatistic{}, err
	}
	return typedFrom[UsageStatistic](res), nil
}



func (e *UsageStatisticEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UsageStatisticEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UsageStatisticEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UsageStatisticEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UsageStatisticEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
