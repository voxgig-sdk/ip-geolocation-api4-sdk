...
func NewTorEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *TorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TorEntity) GetName() string { return e.name }
...
func (e *TorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TorEntity) Deleted() bool {
	return e.deleted
}


func (e *TorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTorEntity(e.client, opts)
}

func (e *TorEntity) Data(args ...any) any {
...
func (e *TorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Tor; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TorEntity) DataTyped(data ...Tor) Tor {
	if len(data) > 0 {
		return typedFrom[Tor](e.Data(asMap(data[0])))
	}
	return typedFrom[Tor](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Tor (all fields
// optional at the wire level).
func (e *TorEntity) MatchTyped(match ...Tor) Tor {
	if len(match) > 0 {
		return typedFrom[Tor](e.Match(asMap(match[0])))
	}
	return typedFrom[Tor](e.Match())
}
...
func (e *TorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TorEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TorLoadMatch and returns an Tor. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TorEntity) LoadTyped(reqmatch TorLoadMatch, ctrl map[string]any) (Tor, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Tor{}, err
	}
	return typedFrom[Tor](res), nil
}



func (e *TorEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
