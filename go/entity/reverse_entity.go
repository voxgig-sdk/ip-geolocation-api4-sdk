...
func NewReverseEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *ReverseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReverseEntity) GetName() string { return e.name }
...
func (e *ReverseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReverseEntity) Deleted() bool {
	return e.deleted
}


func (e *ReverseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReverseEntity(e.client, opts)
}

func (e *ReverseEntity) Data(args ...any) any {
...
func (e *ReverseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Reverse; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReverseEntity) DataTyped(data ...Reverse) Reverse {
	if len(data) > 0 {
		return typedFrom[Reverse](e.Data(asMap(data[0])))
	}
	return typedFrom[Reverse](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Reverse (all fields
// optional at the wire level).
func (e *ReverseEntity) MatchTyped(match ...Reverse) Reverse {
	if len(match) > 0 {
		return typedFrom[Reverse](e.Match(asMap(match[0])))
	}
	return typedFrom[Reverse](e.Match())
}
...
func (e *ReverseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReverseEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReverseLoadMatch and returns an Reverse. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReverseEntity) LoadTyped(reqmatch ReverseLoadMatch, ctrl map[string]any) (Reverse, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Reverse{}, err
	}
	return typedFrom[Reverse](res), nil
}



func (e *ReverseEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReverseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReverseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReverseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReverseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
