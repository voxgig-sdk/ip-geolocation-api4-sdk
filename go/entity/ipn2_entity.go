...
func NewIpn2Entity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *Ipn2Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Ipn2Entity) GetName() string { return e.name }

func (e *Ipn2Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIpn2Entity(e.client, opts)
}

func (e *Ipn2Entity) Data(args ...any) any {
...
func (e *Ipn2Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *Ipn2Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Ipn2Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *Ipn2Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Ipn2Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Ipn2Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Ipn2Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
