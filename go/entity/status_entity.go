...
func NewStatusEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *StatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StatusEntity) GetName() string { return e.name }
...
func (e *StatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StatusEntity) Deleted() bool {
	return e.deleted
}


func (e *StatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStatusEntity(e.client, opts)
}

func (e *StatusEntity) Data(args ...any) any {
...
func (e *StatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Status; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StatusEntity) DataTyped(data ...Status) Status {
	if len(data) > 0 {
		return typedFrom[Status](e.Data(asMap(data[0])))
	}
	return typedFrom[Status](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Status (all fields
// optional at the wire level).
func (e *StatusEntity) MatchTyped(match ...Status) Status {
	if len(match) > 0 {
		return typedFrom[Status](e.Match(asMap(match[0])))
	}
	return typedFrom[Status](e.Match())
}
...
func (e *StatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StatusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StatusLoadMatch and returns an Status. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StatusEntity) LoadTyped(reqmatch StatusLoadMatch, ctrl map[string]any) (Status, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Status{}, err
	}
	return typedFrom[Status](res), nil
}



func (e *StatusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *StatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
