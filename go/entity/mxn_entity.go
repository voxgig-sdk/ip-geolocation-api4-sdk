...
func NewMxnEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *MxnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MxnEntity) GetName() string { return e.name }
...
func (e *MxnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MxnEntity) Deleted() bool {
	return e.deleted
}


func (e *MxnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMxnEntity(e.client, opts)
}

func (e *MxnEntity) Data(args ...any) any {
...
func (e *MxnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Mxn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MxnEntity) DataTyped(data ...Mxn) Mxn {
	if len(data) > 0 {
		return typedFrom[Mxn](e.Data(asMap(data[0])))
	}
	return typedFrom[Mxn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Mxn (all fields
// optional at the wire level).
func (e *MxnEntity) MatchTyped(match ...Mxn) Mxn {
	if len(match) > 0 {
		return typedFrom[Mxn](e.Match(asMap(match[0])))
	}
	return typedFrom[Mxn](e.Match())
}
...
func (e *MxnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MxnEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MxnLoadMatch and returns an Mxn. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MxnEntity) LoadTyped(reqmatch MxnLoadMatch, ctrl map[string]any) (Mxn, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Mxn{}, err
	}
	return typedFrom[Mxn](res), nil
}



func (e *MxnEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MxnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MxnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MxnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MxnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
