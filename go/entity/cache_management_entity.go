...
type CacheManagementEntity struct {
	name    string
...
func NewCacheManagementEntity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *CacheManagementEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CacheManagementEntity) GetName() string { return e.name }
...
func (e *CacheManagementEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CacheManagementEntity) Deleted() bool {
	return e.deleted
}


func (e *CacheManagementEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCacheManagementEntity(e.client, opts)
}

func (e *CacheManagementEntity) Data(args ...any) any {
...
func (e *CacheManagementEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CacheManagement; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CacheManagementEntity) DataTyped(data ...CacheManagement) CacheManagement {
	if len(data) > 0 {
		return typedFrom[CacheManagement](e.Data(asMap(data[0])))
	}
	return typedFrom[CacheManagement](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CacheManagement (all fields
// optional at the wire level).
func (e *CacheManagementEntity) MatchTyped(match ...CacheManagement) CacheManagement {
	if len(match) > 0 {
		return typedFrom[CacheManagement](e.Match(asMap(match[0])))
	}
	return typedFrom[CacheManagement](e.Match())
}
...
func (e *CacheManagementEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CacheManagementEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CacheManagementLoadMatch and returns an CacheManagement. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CacheManagementEntity) LoadTyped(reqmatch CacheManagementLoadMatch, ctrl map[string]any) (CacheManagement, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CacheManagement{}, err
	}
	return typedFrom[CacheManagement](res), nil
}



func (e *CacheManagementEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CacheManagementEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CacheManagementEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *CacheManagementEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// CacheManagementRemoveMatch and returns an CacheManagement. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CacheManagementEntity) RemoveTyped(reqmatch CacheManagementRemoveMatch, ctrl map[string]any) (CacheManagement, error) {
...
func (e *CacheManagementEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
