...
func NewIpInfoV0Entity(client *core.IpGeolocationApi4SDK, entopts map[string]any) *IpInfoV0Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IpInfoV0Entity) GetName() string { return e.name }
...
func (e *IpInfoV0Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IpInfoV0Entity) Deleted() bool {
	return e.deleted
}


func (e *IpInfoV0Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIpInfoV0Entity(e.client, opts)
}

func (e *IpInfoV0Entity) Data(args ...any) any {
...
func (e *IpInfoV0Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IpInfoV0; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IpInfoV0Entity) DataTyped(data ...IpInfoV0) IpInfoV0 {
	if len(data) > 0 {
		return typedFrom[IpInfoV0](e.Data(asMap(data[0])))
	}
	return typedFrom[IpInfoV0](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IpInfoV0 (all fields
// optional at the wire level).
func (e *IpInfoV0Entity) MatchTyped(match ...IpInfoV0) IpInfoV0 {
	if len(match) > 0 {
		return typedFrom[IpInfoV0](e.Match(asMap(match[0])))
	}
	return typedFrom[IpInfoV0](e.Match())
}
...
func (e *IpInfoV0Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IpInfoV0Entity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IpInfoV0LoadMatch and returns an IpInfoV0. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IpInfoV0Entity) LoadTyped(reqmatch IpInfoV0LoadMatch, ctrl map[string]any) (IpInfoV0, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return IpInfoV0{}, err
	}
	return typedFrom[IpInfoV0](res), nil
}



func (e *IpInfoV0Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IpInfoV0Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IpInfoV0Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IpInfoV0Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IpInfoV0Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
